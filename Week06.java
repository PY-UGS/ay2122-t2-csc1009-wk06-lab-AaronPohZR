...
public class Week06 {
    ...
    public void wk06_question3(){
        ...
        System.out.print("Linklist repeated number position ");

        if (findValue(linkedList, numGenerated) > -1 ){
            int position = (findValue(linkedList, numGenerated));
    ...
    public void wk06_question6(){
        ...
        int numGenerated = numGenerator(1000, 9999);
        System.out.print("LinkedHashMap repeated number position ");

        if (findValue(linkedHashMap, numGenerated) > -1 ){
            int position = (findValue(linkedHashMap, numGenerated));
            System.out.println("found at " + position);
        }
        else{
            System.out.println("not found.");
